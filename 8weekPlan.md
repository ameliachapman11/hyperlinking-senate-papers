...
* Look further into alternative methods of storing Senate papers, moving away from PDF's and towards databases
* Develop questions to ask Senate members in a requirements gathering meeting
* (If recommendations approved by advisor) Begin building a concrete prototype of the website &rarr; focusing on website structure and file storage to start 

## Weeks 4-6
* Hold a requirements gathering meetings with Senate members, showing them the mockup as a starting point
...
* Create questions to ask during second stakeholder meeting
...
* Changing requirements: Requirements may shift after the stakeholder meetings, particularly in week 7 once Senate members interact with a prototype rather than just viewing a mockup, so some planned features may need to be reprioritized or reduced in response to feedback.
