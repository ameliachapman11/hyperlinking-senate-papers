...
* Look into alternative methods of storing Senate papers, moving away from PDF's and towards databases
* Look at the UI structure of existing database software for inspiration, create Figma mockup
* **Overarching goal:** Decide which method I will be creating the web app with (could be Links, React, Vue, NodeJS, etc.)

## Week 3
* Develop questions to ask Senate members in a requirements gathering meeting to understand what their thought process is when they look through Senate documents, what they would like to search for/how they would like to search, if/how they would like to filter results
* (If possible to schedule) Hold a requirements gathering meetings with Senate members, showing them the mockup as a starting point
* Begin building a concrete prototype of the website &rarr; focusing on website structure and file storage to start 
...
## Week 7
* Create questions to ask during stakeholder meeting
* Schedule meetings with stakeholders/Senate members to recieve feedback on
