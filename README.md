...
* The `internship` folder consists of documentation created throughout the internship, primarily used for the purpose of communicating my research progress with my advisor. For more information on the different files within the `internship` folder, please see the [File Guide](internship/file-guide.md). 
