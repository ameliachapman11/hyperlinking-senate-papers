...
use Org\Wplake\Advanced_Views\Cpt\Data_Vendors\Pods\Fields\Pods_Pick_Field;
use Org\Wplake\Advanced_Views\Cpt\Data_Vendors\Pods\Fields\Pods_Upload_Field;
		...
		switch ( $field_type ) {
			case 'datetime':
				...
				if ( 'wp' === $date_time_type ) {
					...
					return sprintf( '%s %s', string( $date_format ), string( $time_format ) );
				}
