...
$link_attributes = xpro_elementor_get_link_attributes( $settings['button_link'], 'div' );

$btn_tag  = $link_attributes['tag'];
$attr     = $link_attributes['attr'];

if ( ! empty( $settings['button_css_id'] ) ) {
	$attr .= ' id="' . esc_attr( $settings['button_css_id'] ) . '"';
}
...
<div class="xpro-pricing-item">
	...
	if ( 'before_features' === $settings['button_position'] && $settings['button_title'] ) {
		...
		<div class="xpro-pricing-btn-wrapper">
			<a class="xpro-pricing-btn" <?php echo wp_kses_data( $attr ); ?>><?php echo esc_html( $settings['button_title'] ); ?></a>
		</div>
	<?php } ?>
