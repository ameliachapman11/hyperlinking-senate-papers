...
echo esc_attr( $settings['layout'] ); ?>" method="get" id="searchform" autocomplete="off" action="<?php echo esc_url( home_url( '/' ) ); ?>" role="search">
	...
	<div class="xpro-elementor-search-inner">
		...
		<div class="xpro-elementor-search-input-group">
			...
			<?php if ( '4' !== $settings['layout'] && '5' !== $settings['layout'] ) : ?>
				<button aria-label="Search" id="searchsubmit" class="xpro-elementor-search-button" type="submit">
					<?php
		...
		<?php if ( '4' === $settings['layout'] || '5' === $settings['layout'] ) : ?>
			<button aria-label="Close" class="xpro-elementor-search-button-close" type="button">
			</button>
		<?php endif; ?>
	...
	<?php if ( '4' === $settings['layout'] || '5' === $settings['layout'] ) : ?>
		<button aria-label="Search Button" class="xpro-elementor-search-button" type="button">
			<?php
			if ( 'text' === $settings['button_type'] ) {
				echo esc_html( $settings['button_text'] );
			} else {
