...
<div class="xpro-compare-wrapper xpro-compare-handle-show-<?php echo esc_attr( $settings['display_handle'] ); ?> xpro-compare-label-show-<?php echo esc_attr( $settings['display_label'] ); ?>">
	...
	<div class="xpro-compare-item">
		...
		echo ! empty( $before_image_markup ) ? wp_kses_post($before_image_markup) : '<img src="' . esc_url( $settings['before_image']['url'] ) . '">';
		...
		echo ! empty( $after_image_markup ) ? wp_kses_post($after_image_markup) : '<img src="' . esc_url( $settings['after_image']['url'] ) . '">';
		?>
		<!--Label-->
