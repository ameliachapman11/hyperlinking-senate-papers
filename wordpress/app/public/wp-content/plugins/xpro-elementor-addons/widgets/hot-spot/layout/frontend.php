...
<div class="xpro-hotspot-wrapper">
	...
	$link_attributes = xpro_elementor_get_link_attributes( $item['link'], 'span' );
	$html_tag        = $link_attributes['tag'];
	$attr            = $link_attributes['attr'];
	?>

	<<?php echo esc_attr( $html_tag ); ?> <?php echo wp_kses_data( $attr ); ?> class="elementor-repeater-item-<?php echo esc_attr( $item['_id'] ); ?> xpro-hotspot-item">
